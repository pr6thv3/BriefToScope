  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Retention", body: "Workspace content is retained while an account is active unless deletion is requested or a custom retention policy applies. See the Data Retention Policy for operational retention details. Logs and webhook events may be retained for security, billing, and audit purposes." },
