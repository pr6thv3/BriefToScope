  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Human review", body: "Generated SOWs are AI-assisted drafts. They may contain errors, omissions, or commercially inappropriate language. Users must review and approve every document before sending it to clients." },
