...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      sections={[
        { title: "Service", body: "BriefToScope provides AI-assisted tools for drafting, editing, auditing, exporting, and sending Statements of Work. The service does not provide legal advice." },
        ...
        { title: "Billing", body: "Paid subscriptions are managed through PayPal. Plan access, usage limits, renewals, cancellations, and failed payments are governed by the selected plan and provider status." },
